...
const siginAuthentication = (db, bcrypt) => (req, res) => {
  const { authorization } = req.headers;
  return authorization ? getAuthTokenId(req, res) : 
    validateSignin(db, bcrypt, req, res)
      .then(data => {
...
const validateSignin = (db, bcrypt, req, res) => {
...
module.exports = {
  siginAuthentication: siginAuthentication
}